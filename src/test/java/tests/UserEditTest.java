...
public class UserEditTest extends BaseTestCase {
    ...
    public void TestForEditUser() {
        ...
        apiCoreRequests.makePostRequest("https://playground.learnqa.ru/api/user/", newUser);
        Map<String, String> authData = new HashMap<>();
        ...
        Response responseCreateUserForEdit = apiCoreRequests.makePostRequest("https://playground.learnqa.ru/api/user/", targetUser);
        String userId = responseCreateUserForEdit.jsonPath().getString("id");
        Response AuthResponse = apiCoreRequests.makePostRequest("https://playground.learnqa.ru/api/user/login/", authData);
